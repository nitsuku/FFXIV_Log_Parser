...
def fightSelect(fightName, logLoc) :#, loop) :
    ...
    if (fightName == "TEA"):
        ...
        fightID = "800375BF"
        phaseColors = ['r','b','y','violet','g','gold']
        phases = [2.76,5.9,7.1,10.3,13.4,22]
        phaseNames = ["Thajit","Shiva","Transition","Gaia","Lesbians","Pandora"]
        transitions = ["Fools..", "Aaaaaahhh!", "I am Loghrif", "Her awakening is incomplete", "Add me","defeats XXX"]
    elif (fightName == "TOP"):
        ...
        fightID = "800375D2"
        phaseColors = ['b','r','y','c','gold']
        phases = [3.5,6.2,11.8,14.5,18.1]
        phaseNames = ["Kefka","Forsaken","Chaos ExDeath","Kefka-Says","ULTIMA KEFKA"]
    elif (fightName == "E10S"):
...
def check_and_install_dependencies(dependencies):
    """
    Check for missing dependencies and install them if the user agrees.
    """
    ...
    if missing_dependencies:
        ...
        if choice == 'y':
            ...
            print("Missing dependencies are required. Exiting.")
            sys.exit(1)

# Define your required dependencies
required_dependencies = ["requests", "matplotlib", "PyInstaller", "threading", "re", "datetime", "os", "time", "sys", "sortedcontainers", "imageio", "glob", "shutil"]
...
def startApplication():
    ...
    class BaseGui:
        global fightarray
        fightarray = ["TEA","UWU","UCoB","DSU","TOP","FRU","UMAD"]##to be updated/removed
        ...
        def __init__( self, master ):
            ...
            self.fightsCombo.set("UMAD") ##DEFAULT APPEARANCE. Change if you are progging just one fight for ease.
...
if __name__ == "__main__": 
    ...
    print("All dependencies are satisfied. Running the application...")
